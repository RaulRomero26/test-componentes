...
export const BaseMultiplier = () => {
  ...
  return (
    <>
    <div>
        <button onClick={onAddInstanciaRemisiones}>AÑADIR INSTANCIA SARAI REMISIONES </button>
        <button onClick={onAddInstanciaInspecciones}>AÑADIR INSTANCIA SARAIINSPECCIONES </button>
        <button onClick={onAddInstanciaHistorico}>AÑADIR INSTANCIA HISTORICO </button>
        <button onClick={onAddInstanciaEventosDelictivos}>AÑADIR INSTANCIA EVENTOS DELICTIVOS </button>
    ...
    <div className="row mt-3">
        <div className="col">
            <SelectBaseComponent  base={'SARAI EVENTOS DELICTIVOS'} />
